...
// Logic to fetch User Data for the Header (Added for Styling consistency)
        ...
        <div class="admin-main">
            ...
            <div class="dashboard-content">
                ...
                <div class="content-card">
                    <h2 class="section-header"><i class="fas fa-plus-circle"></i> Add Payment Option</h2>
                    <form method="post" class="row g-3">
                        <input type="hidden" name="action" value="add_payment">
                        <div class="col-md-6">
                            <label class="form-label">New Payment Option Name</label>
                            <input type="text" name="name" class="form-control" required placeholder="e.g. bKash, Nagad, Credit Card">
                        </div>
                        <div class="col-12 mt-3">
                            <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Add Option</button>
                        </div>
                    </form>
                </div>

                <div class="content-card">
                    <h3 class="section-header"><i class="fas fa-list"></i> Existing Payment Options</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post" style="display:inline;">
                                                ...
                                                <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this payment option?')">
